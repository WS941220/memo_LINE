...
class MemosRepository(
    val tasksRemoteDataSource: MemosDataSource,
    val tasksLocalDataSource: MemosDataSource
) : MemosDataSource {

//    /**
//     * This variable has public visibility so it can be accessed from tests.
//     */
//    var cachedMemos LinkedHashMap<String, Meno> = LinkedHashMap()
//
//    /**
...
//     * get the data.
//     */
//    override fun getTasks(callback: MemosDataSource.LoadTasksCallback) {
...
//    }
    ...
    companion object {
         ...
         */
        @JvmStatic fun getInstance(tasksRemoteDataSource: MemosDataSource,
                                   tasksLocalDataSource: MemosDataSource): MemosRepository {
            return INSTANCE ?: MemosRepository(tasksRemoteDataSource, tasksLocalDataSource)
                .apply { INSTANCE = this }
        }
